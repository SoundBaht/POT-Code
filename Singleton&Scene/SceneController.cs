...
public class SceneController : MonoBehaviour
{
    ...
    public void LoadScene(string sceneName) {                       //Load new scene with transition only
        ...
        //     GameManager.instance.killCounts = PlayerPrefs.GetInt("PlayerKills");
        //     GameManager.instance.deadCounts = PlayerPrefs.GetInt("PlayerDeads");
        //     GameManager.instance.healCounts = PlayerPrefs.GetInt("PlayerHeals");
        // }
